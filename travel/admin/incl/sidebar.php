            ...
            <li>
                ...
                <div class="collapse" id="tables" aria-expanded="false" style="height: 0px;">
                    <ul class="nav">
                        ...
                        <li><a href="../pages/tables/vehicles.php">Vehicles</a></li>
                        <li><a href="../pages/tables/payables.php">Payments</a></li>
                        <li><a href="../pages/tables/reservations.php">Reservations</a></li>
                        <li><a href="tables/data-tables.html">Drivers</a></li>
                        <li><a href="tables/data-tables.html">Users</a></li>
                    </ul>
                </div>
            </li>
            <li>
